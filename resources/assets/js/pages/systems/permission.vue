    ...
    <section class="content">
      <div class="row">
        <div class="col-sm-9">
          ...
          <button class="btn btn-default" @click.prevent="createItem"><i class="fa fa-plus"></i> เพิ่มสิทธิ์</button>
        </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">จัดการข้อมูลสิทธิ์</h4>
          </div>
          <div class="modal-body">
            <div class="form-group">
              <label class="col-sm-2 col-md-3 control-label">ชื่อสิทธิ์<span class="text-danger">*</span></label>
