    ...
    <section class="content">
      <div class="row">
        <div class="col-sm-9">
          ...
          <button class="btn btn-default" @click.prevent="createItem"><i class="fa fa-plus"></i> เพิ่มบริษัทประกัน</button>
        </div>
        <div class="col-sm-3 hidden-xs">
          <strong>Tips</strong>
          <div>
            การกรอกข้อมูลบริษัทประกัน<br><br>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">จัดการบริษัทประกัน</h4>
          </div>
          <div class="modal-body">
            <div class="form-group">
              <label class="col-sm-2 col-md-3 control-label">ชื่อบริษัทประกัน<span class="text-danger">*</span></label>
  ...
  export default {
    ...
    data() {
      return {
        ...
        config:{
          table: 'itemTable',
          title: 'รายชื่อบริษัทประกัน',
          api: '/api/v1/setting/insurance/companies/',
          edit: true,
          hidden: ['id'],
          columns: [
            {
              name:'ชื่อบริษัทประกัน',
              width: 90
            }, 
          ],
        },
